...
export const about = () => {
  return (
    <>
      ...
      deployments. My approach prioritizes people over technology. My expertise
      extends to process automation and integration and pipelines, which allows
      me to help clients optimize their productivity and efficiency through the
